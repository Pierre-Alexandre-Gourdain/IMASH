...
**IMASH** is a lightweight C++ library that extracts plasma and machine data from **IMAS** and maps it into solver-ready data structures.
...
* add a **diagram (IMAS → IMASH → AMReX)**
* or write a **minimal example repo structure**
* or add **build instructions (CMake + IMAS)**
